...
public class Main extends Application implements EventHandler<ActionEvent>
{
    ...
    @Override 
        ...
        public void start(Stage mainwin) throws Exception
        {
            ...
            ChoiceBox cxb = new ChoiceBox();
            
            cxb.getItems().add("apples"); // Adds to the list
            
            cxb.getItems().addAll("pie", "cake"); //Adds multiple items to the list
                        
            cxb.setValue("pie"); //Presets the choice box
            ...
            //Add the contents 
            layout.getChildren().addAll(cxb, cb, username, nameInput, passwd, passwdInput, bttn);
