...
public class Main extends Application implements EventHandler<ActionEvent>
{
    ...
    @Override 
        ...
        public void start(Stage mainwin) throws Exception
        {
            ...
            bttn.setOnAction( e ->
                {
                    //ObservableList<String> lst = listview.getSelectionModel().getSelectedItems();
                }

            );

            //Add the contents 
            layout.getChildren().addAll(listview, combobox, cxb, cb, username, nameInput, passwd, passwdInput, bttn);
